          ...
          <div className=" min-h-screen m-5 px-10 py-10 mb-10">
            ...
            <div className="contectWarp md:ml-auto md:mr-auto flex flex-col items-center  justify-center xl:text-3xl sm:text-xl  ">
              <div className="flex mb-10">
                <span className=" font-blod ">카카오톡 오픈채팅 :</span>
              ...
              <div className="flex mb-10">
                <span className=" font-blod ">인스타그램 :</span>
              ...
              <div className="flex mb-10">
                ...
                <span className=" font-blod ">이메일 :</span>
                <span className=" pl-3 text-blue-500  pr-5 ">
              ...
              <div className="flex mb-10">
                ...
                <span className=" font-blod ">연락처 :</span>
                <span className=" pl-3 text-blue-500 pr-5 ">010-6622-9124</span>
              </div>
            </div>
          </div>
        </div>
