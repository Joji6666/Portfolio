        ...
        <div className=" min-h-screen m-5 px-10 py-10 mb-10">
          ...
          <div className="md:ml-auto md:mr-auto flex flex-col items-center  justify-center">
            <div className="flex mb-10">
              ...
              <span className="text-3xl font-blod">이름 :</span>
              <span className="text-3xl pl-3 text-blue-500 pr-5 ">김진</span>
            </div>
            <div className="flex mb-10">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="text-3xl font-blod">생년월일 :</span>
            ...
            <div className="flex mb-10">
              ...
              <span className="text-3xl font-blod">학력 :</span>
            ...
            <div className="flex mb-10">
              ...
              <span className="text-3xl font-blod">주소지 :</span>
              <span className="text-3xl pl-3 text-blue-500 pr-5 ">
                경기도 성남시 중원구
              </span>
            </div>
